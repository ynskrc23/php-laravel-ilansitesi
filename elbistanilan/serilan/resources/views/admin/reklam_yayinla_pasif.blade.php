...
<div style="margin-top:15px; margin-left:10px;" class="container-fluid">
  <div class="row content">
    ...
    <div class="col-sm-9">
		...
		<div style="margin-top:16px; background-color:#607d8bb5; color:white; text-align:center;" class="well well-sm">Pasif Kayıtlar</div>   
      ...
      <tbody>
          @foreach ($all_reklam_pasif as $rs) 
              <tr class="odd gradeX">
                
                <td>
                    @if($rs->reklamy_image != null)
                    <img src="{{\Illuminate\Support\Facades\Storage::url($rs->reklamy_image)}}" style="height: 80px" width="160px;"> </td>
                   ...
                   <td> {{Carbon::parse($rs->created_at)->diffForHumans()}}  </td>
                   <td> {{$rs->reklamy_alan}} </td>
                <td class="center">
                    @if($rs->reklamy_durum==1)
                ...
                <td class="center">  
                <a href="/edit-reklamyayinla/{{$rs->reklamy_id}}" class="btn btn-info"> Güncelle </a>                                                                                                     
                <a href="/delete-reklamyayinla/{{$rs->reklamy_id}}" class="btn btn-danger"  onclick="return ShowConfirm();"> Delete </a>                                            
                </td>   
              </tr> 
          @endforeach
      </tbody>
		...
		<div class="text-center"> {{ $all_reklam_pasif->links() }} </div>
		</div>
    </div>
