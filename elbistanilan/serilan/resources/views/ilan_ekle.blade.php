...
<body>
  ...
  <section> 
    ...
    <div  class="col-sm-7 padding-right">
	 <h2 class="title text-center">İlan Ekleme</h2>
  ...
  <form class="inline-form" action="{{route('addilan')}}" method="POST" enctype="multipart/form-data">
    {{ csrf_field() }} 
        <div class="row">
            ...
            <div class="col-sm-6">              
                <div class="form-group">
                    ...
                    <select class="form-control" val-type="select" name="kat_id" required>
                  ...
                  <div class="form-group">
                        ...
                        <input type="text" name="ilan_baslik" class="form-control" placeholder="İlan Baslığı" required>
                        <span class="help-block"></span>
                    </div>
                </div>
            </div>
                ...
                <div class="row">                              		
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="ilan_adi" placeholder="Adı" required>
                        <span class="help-block"></span>
                    </div>
                </div>
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="ilan_soyadi" class="form-control" placeholder="Soyadı" required>
                        <span class="help-block"></span>
                    </div>
                </div>
            </div>
              	...
              	<div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <input type="email" class="form-control" name="ilan_email" placeholder="@" required>
                    ...
                    <div class="form-group">
                           <label class="control-label">Adres </label>
                            <input type="text" class="form-control" name="ilan_adresi" placeholder="Adres" required>
                            <span class="help-block"></span>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">                        
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="ilan_fiyat" placeholder="TL" required>
                        <span class="help-block"></span>
                    </div>
                 </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="ilan_telefon" placeholder="Telefon" required>
                        <span class="help-block"></span>
                    </div>
                </div>
               </div>
              ...
              <div class="row">	
                  <div class="col-sm-12">
                      <div class="form-group">
                          ...
                          <textarea class="form-control col-sm-8" rows="6" name="ilan_detay" placeholder="İlan Detayları" required></textarea>
                      </div>
                  </div>
              </div>
            ...
            <div class="row">
              <div style="margin-top:10px;"  class="col-sm-12">
                ...
                <div class="input-group control-group increment" >
                  <label for="exampleFormControlFile1">Fotograf Ekle</label>
                  <input type="file" name="ilan_image">
                </div>
            ...
            <div class="row">
              <div class="col-sm-12">
                  <div class="form-group">
                      <button type="submit" class="btn btn-success btn-default pull-right">Devam</button>
                  </div>
              </div>
            </div>
